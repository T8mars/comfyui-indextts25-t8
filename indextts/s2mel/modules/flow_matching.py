...
class BASECFM(torch.nn.Module, ABC):
    ...
    def inference(self, mu, x_lens, prompt, style, f0, n_timesteps, temperature=1.0,
                  inference_cfg_rate=0.5, interrupt_callback=None):
        """Forward diffusion
    ...
    def solve_euler(self, x, x_lens, prompt, mu, style, f0, t_span,
                    inference_cfg_rate=0.5, interrupt_callback=None):
        """
